...
```bash
pip install -r docling_lib/requirements.txt
```
...
```bash
# Тест одного UNIT
python -m docling_lib.test_pipeline --date 2025-12-20 --unit UNIT_xxx

# Тест всех UNIT за дату (с лимитом)
python -m docling_lib.test_pipeline --date 2025-12-20 --limit 5
```
