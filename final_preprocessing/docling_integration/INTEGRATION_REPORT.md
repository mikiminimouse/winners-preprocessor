...
**Файл:** `docling/bridge_docprep.py`
...
**Файл:** `docling/tests/test_integration.py`
...
3. **Тестирование docling pipeline:**
   ```bash
   python3 docling/tests/test_integration.py final_preprocessing/Data/2025-03-20 --limit 5
   ```
