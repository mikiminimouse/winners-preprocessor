...
- **Поддерживаемые конвертации**:
  ...
  - PPT → PPTX
  - RTF → DOCX
- **Особенности**: Перемещение в Merge_N/Converted/ после конвертации
...
- **Функции**: Сортировка по расширениям, разделение PDF на scan/text
...
- **Функции**: Поиск UNIT, получение файлов, создание структуры
